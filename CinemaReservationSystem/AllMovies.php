...
if($result=mysqli_query($link,$sql))
{
	...
	{
		echo "<table><tr><th>Id</th><th>Movie Name</th><th>Director</th><th>Subject</th><th>Description</th><th>Genre</th><th>Length</th><th>Vision Date</th><th>Operations</th><th></tr>";
		while($row=mysqli_fetch_array($result))
		{   echo " ";
			echo "<tr><td>".$row['m_id']."</td><td>".$row['m_name']."</td><td>".$row['m_director']."</td><td>".$row['m_subject']."</td><td>".$row['m_description']."</td><td>".$row['m_genre']."</td><td>".$row['m_length']."</td><td>".$row['m_visionDate']."</td>";
			echo '<td><a href="DeleteMovie.php?id='.$row['m_id'].'">Delete</a>';
			echo '<td><a href="Booking.php?id='.$row['m_id'].'">Booking</a></td></tr>';
		}
		echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>";
		echo '<td><a class=ss  href="AddMovie.php"> Add a new movie </a></td></tr>';
		echo "</table>";
	}else
	{
